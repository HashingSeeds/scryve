  ...
  sections: [
    ...
    },
    {
      ...
      blocks: [
        {
          type: "paragraph",
          text: 'We are Hashing Seeds LLC ("Company," "we," "us," "our"), a company registered in Tennessee, United States at 901 Broadway #24210, Nashville, TN 37202.',
        },
        {
          type: "paragraph",
    ...
    },
    {
      ...
      blocks: [
        ...
        {
          type: "paragraph",
          text: "14. PRIVACY POLICY",
        },
        {
          type: "paragraph",
          text: "15. TERM AND TERMINATION",
        },
        {
          type: "paragraph",
          text: "16. MODIFICATIONS AND INTERRUPTIONS",
        },
        {
          type: "paragraph",
        ...
        {
          type: "paragraph",
          text: "21. LIMITATIONS OF LIABILITY",
        },
        {
          type: "paragraph",
        ...
        {
          type: "paragraph",
          text: "24. ELECTRONIC COMMUNICATIONS, TRANSACTIONS, AND SIGNATURES",
        },
        {
          type: "paragraph",
          text: "25. CALIFORNIA USERS AND RESIDENTS",
        },
        {
          type: "paragraph",
          text: "26. MISCELLANEOUS",
        },
        {
          type: "paragraph",
          text: "27. CONTACT US",
    ...
    },
    {
      ...
      blocks: [
        ...
        {
          type: "paragraph",
          text: "If you wish to make any use of the Services, Content, or Marks other than as set out in this section or elsewhere in our Legal Terms, please address your request to: contact@sowinghope.how. If we ever grant you the permission to post, reproduce, or publicly display any part of our Services or Content, you must identify us as the owners or licensors of the Services, Content, or Marks and ensure that any copyright or proprietary notice appears or is visible on posting, reproducing, or displaying our Content.",
        },
        {
          type: "paragraph",
    ...
    {
      heading: "12. MOBILE APPLICATION LICENSE",
      blocks: [],
    },
    {
      heading: "Use License",
    ...
    },
    {
      ...
      blocks: [
        ...
        {
          type: "paragraph",
          text: "In no event shall any Dispute brought by either Party related in any way to the Services be commenced more than one (1) years after the cause of action arose. If this provision is found to be illegal or unenforceable, then neither Party will elect to arbitrate any Dispute falling within that portion of this provision found to be illegal or unenforceable and such Dispute shall be decided by a court of competent jurisdiction within the courts listed for jurisdiction above, and the Parties agree to submit to the personal jurisdiction of that court.",
        },
      ],
    },
    {
    ...
    {
      heading: "25. CALIFORNIA USERS AND RESIDENTS",
      blocks: [
        {
          type: "paragraph",
