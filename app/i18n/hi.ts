...
const hi: Translations = {
  ...
  landingScreen: {
    ...
    comingSoonMessage: "यह प्रवेश बिंदु Count के अगले कार्यान्वयन चरण के लिए तैयार है।",
    dismissComingSoon: "समझ गया",
  },
  errorScreen: {
    title: "कुछ गलत हो गया",
    friendlySubtitle:
      "Count में एक अनपेक्षित त्रुटि हुई। साफ़ स्थिति में लौटने के लिए ऐप रीसेट करें। समस्या जारी रहे तो डेवलपमेंट क्लाइंट पुनः शुरू करें।",
    reset: "ऐप रीसेट करें",
  },
  emptyStateComponent: {
    generic: {
