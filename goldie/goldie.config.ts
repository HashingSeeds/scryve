  ...
  scenes: [
    {
      ...
      headline: { "en-US": "Your table. Your game." },
      subhead: { "en-US": "Life totals for up to six players." },
    },
    {
      kind: "screenshot",
      id: "new-game",
      ...
      subhead: { "en-US": "Play on one device or across the table." },
    },
    {
      kind: "screenshot",
      id: "deck",
    ...
    },
    {
      kind: "screenshot",
      id: "history",
      flow: "store-07-history",
      layout: "hero",
      headline: { "en-US": "See how it went." },
      subhead: { "en-US": "Past games and results, all in one place." },
    },
    {
      kind: "screenshot",
      id: "controls",
      flow: "store-04-six-player-controls",
      headline: { "en-US": "Keep the game moving." },
      subhead: { "en-US": "Reach game options from every seat." },
    },
    {
      kind: "preview",
      id: "preview",
